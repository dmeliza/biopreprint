...
\ifnum 0\ifxetex 1\fi\ifluatex 1\fi=0 % if pdftex
  ...
  % biopreprint: default typeface is palatino, deal with it
  \usepackage{mathpazo}
...
%% biopreprint: custom formatting options here
...
%% biopreprint: fix caption formatting
...
\fancyhead{}
\fancyfoot{}
\fancyhead[L]{\sffamily $header.authors$ --- $header.running-title$ (\textbf{preprint})}
...
$if(author)$
\paragraph{Authors:} $for(author)$$author.name$$sep$; $endfor$
\paragraph{Affiliations:} $for(author)$$author.affiliation$$sep$; $endfor$
$endif$
$if(corresponding-email)$
\paragraph{Corresponding author:}$corresponding-email$
$endif$
